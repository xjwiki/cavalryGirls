...
let dirRepeatAnchor = $(/*html*/`
	...
	<li class="xjDir-spread">
		...
		<ul>
			...
			<li class="xjDir-disabled"><a href="./data_role_thought.html">			<i class="xjDir-icon fas fa-book-open-reader"></i>		<i class="xjDir-text"><span>思潮影响</span></i></a></li><!--◇书籍列表◇-->
			<li class="xjDir-disabled"><a href="./data_role_loyalty.html">			<i class="xjDir-icon fas fa-heart"></i>					<i class="xjDir-text"><span>忠诚好感</span></i></a></li><!--◇礼品列表◇-->
			<li class="xjDir-disabled"><a href="./data_role_skill.html">			<i class="xjDir-icon fas fa-star"></i>					<i class="xjDir-text"><span>战场技能</span></i></a></li>
			<li class="xjDir-disabled"><a href="./data_role_level.html">			<i class="xjDir-icon fas fa-medal"></i>					<i class="xjDir-text"><span>军衔等级</span></i></a></li>
			<li class="xjDir-disabled"><a href="./data_role_jewelry.html">			<i class="xjDir-icon fas fa-gem"></i>					<i class="xjDir-text"><span>饰品装备</span></i></a></li><!--◇玉制饰品◇-->
			<li class="xjDir-divide"></li>
			...
			<li class="xjDir-disabled"><a href="./data_module_list.html">			<i class="xjDir-icon fas fa-gear"></i>					<i class="xjDir-text"><span>家具清单</span></i></a></li>
			
			<li class="xjDir-disabled"><a href="./data_module_list.html">			<i class="xjDir-icon fas fa-gear"></i>					<i class="xjDir-text"><span>术语名词</span></i></a></li>
			<li class="xjDir-disabled"><a href="./data_module_list.html">			<i class="xjDir-icon fas fa-gear"></i>					<i class="xjDir-text"><span>游戏提示</span></i></a></li>
			<li class="xjDir-disabled"><a href="./data_module_list.html">			<i class="xjDir-icon fas fa-gear"></i>					<i class="xjDir-text"><span>台词对白</span></i></a></li>
			
			<li class="xjDir-disabled"><a href="./data_module_list.html">			<i class="xjDir-icon fas fa-gear"></i>					<i class="xjDir-text"><span>全局参数</span></i></a></li>
			<li class="xjDir-disabled"><a href="./data_module_list.html">			<i class="xjDir-icon fas fa-gear"></i>					<i class="xjDir-text"><span>问题合集</span></i></a></li>
		</ul>
	</li>
